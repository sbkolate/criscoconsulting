...
class EntryOfPayment(AccountsController):
...
def get_account_details(account, date):
	frappe.has_permission('Entry Of Payment', throw=True)
	return frappe._dict({
...
def get_payment_entry(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	pe = frappe.new_doc("Entry Of Payment")
