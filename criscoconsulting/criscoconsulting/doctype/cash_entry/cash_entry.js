...
frappe.provide("criscoconsulting.cash_entry");
...
erpnext.accounts.JournalEntry = frappe.ui.form.Controller.extend({
	...
	setup_queries: function() {
		...
		me.frm.set_query("reference_name", "accounts", function(doc, cdt, cdn) {
			...
			// journal entry
			if(jvd.reference_type==="Cash Entry") {
	...
	reference_name: function(doc, cdt, cdn) {
		...
		if(d.reference_name) {
			...
			if (d.reference_type==="Cash Entry" && !flt(d.credit) && !flt(d.debit)) {
				this.get_outstanding('Cash Entry', d.reference_name, doc.company, d);
			}
		}
	},
...
cur_frm.cscript.select_print_heading = function(doc,cdt,cdn){
	if(doc.select_print_heading){
		...
		cur_frm.pformat.print_heading = __("Cash Entry");
}

cur_frm.cscript.voucher_type = function(doc, cdt, cdn) {
	cur_frm.set_df_property("cheque_no", "reqd", doc.voucher_type=="Cash Entry");
	cur_frm.set_df_property("cheque_date", "reqd", doc.voucher_type=="Cash Entry");
